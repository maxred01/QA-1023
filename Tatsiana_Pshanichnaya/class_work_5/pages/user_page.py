...
class UsersPage:
    ...
    def __init__(self):
        ...
        self.delay_users_url = f"{BASE_URL}/users?delay=3"

    def _requests(self, method, url, **kwargs):
        try:
            response = self.sessions.requests(method, url, **kwargs)
    ...
    def create_user(self, data):
        ...
        return self._requests('GET',f"self.users_url, data=data, timeout=5")
